...
are the entities it names present, do independent sources agree, is any
contradiction still unresolved, and is the evidence diverse enough to mean
anything.  ``verify_claim`` exposes that to the Brain as a tool; the same

...
SCENARIOS: list[Scenario] = [
    ...
    Scenario(
        ...
        subtitle="The corpus cannot answer this, and SPECTRA says so",
        narrative=[
            "The question is asked of a corpus that holds nothing on the subject.",
            "Retrieval runs in full and returns items that are simply off-topic.",
            "No claim is stated: the answer is insufficient evidence, with the gaps named.",
        ],
        question="What caused the Reykjavik warehouse fire in 2019?",
        mode=SearchMode.DEEP,
        expects=["abstention", "insufficient_evidence", "gaps"],
    ),
    Scenario(
        id="timeline",
